...
public class TemplateView extends FrameLayout {
    ...
    public void reinflate() {
        ...
        if (mAdsFrame != null) {
            mAdsFrame.removeAllViews();
        }
        mAdsFrame = new ShimmerFrameLayout(context);
        mAdsFrame.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        inflater.inflate(templateType, mAdsFrame);
    ...
    private void initView(Context context, AttributeSet attributeSet) {
        ...
        try {
            int type = attributes.getResourceId(R.styleable.TemplateView_gnt_template_type, 0);
            templateType = (type == 0) ? R.layout.gnt_medium_template_view : R.layout.gnt_small_template_view;
        } finally {
            attributes.recycle();
        }
        LayoutInflater inflater =
